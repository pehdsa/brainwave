...
const Cobaloration = () => {
    return (
        <Section crosses>
            <div className='container lg:flex relative z-3'>
                        ...
                        <ul>
                            { collabApps.map((item, i) => (
                                <li 
                                    ...
                                    key={ item.id }
                                >
                                    <div className={ `relative -top-[1.6rem] flex w-[3.2rem] h-[3.2rem] bg-n-7 border border-n-1/15 rounded-xl -rotate-${ i * 45 } `}>
                                        <img src={ item.icon } className='m-auto' width={item.width} height={item.height} alt={ item.title } />
                                    </div>
                                </li>
                            )) }
                        </ul>

                ...
                <div className='flex flex-wrap gap-10 mb-10'>
                    { benefits.map(benefit => (
                        ...
                        >
                            ...
                            <div className='absolute inset-0 bg-n-13 bg-conic-gradient' style={{ clipPath: "url(#benefits)" }} />
                            <div
                                className="absolute inset-0.25 bg-n-8"
                                style={{ clipPath: "url(#benefits)" }}
                            >
                                <div className="absolute inset-0 opacity-10 md:opacity-0 transition-opacity md:hover:opacity-10">
                                    {benefit.imageUrl && (
                                        <img
